export default function Home() {
  return (
    <main className="min-h-screen bg-[#0a0e1a] text-white">
      ...
      {/* Hero */}
      <section className="flex flex-col items-center text-center px-8 py-32">
      ...
      <section className="grid grid-cols-3 border-t border-b border-white/10">
        <div className="flex flex-col items-center py-8 border-r border-white/10">
          ...
          <span className="text-white/40 text-sm mt-2">連携大学数</span>
        </div>
        <div className="flex flex-col items-center py-8 border-r border-white/10">
          <span className="text-4xl font-bold text-blue-300">1,200+</span>
          <span className="text-white/40 text-sm mt-2">登録メンバー</span>
        </div>
        <div className="flex flex-col items-center py-8">
          <span className="text-4xl font-bold text-blue-300">48</span>
          <span className="text-white/40 text-sm mt-2">開催イベント数</span>
        </div>
      </section>{/* Events */}
      <section className="px-8 py-20">
        <div className="flex items-center justify-between mb-8 max-w-5xl mx-auto">
          <h2 className="text-2xl font-bold">近日開催のイベント</h2>
      ...
      <footer className="border-t border-white/10 px-8 py-8 flex items-center justify-between flex-wrap gap-4">
        <span className="text-blue-300 font-bold text-lg">UniConnect</span>
        <ul className="flex gap-6 text-sm text-white/30">
